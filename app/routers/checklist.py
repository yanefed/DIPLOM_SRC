...
@checklist_router.get("/", dependencies=[Depends(has_permission("read:checklist"))])
...
@checklist_router.post("/", status_code=status.HTTP_201_CREATED,
                       dependencies=[Depends(has_permission("write:checklist"))])
...
@checklist_router.put("/{checklist_id}", dependencies=[Depends(has_permission("write:checklist"))])
...
@checklist_router.get("/{checklist_id}", dependencies=[Depends(has_permission("read:checklist"))])
...
@checklist_router.delete("/{checklist_id}", dependencies=[Depends(has_permission("write:checklist"))])
